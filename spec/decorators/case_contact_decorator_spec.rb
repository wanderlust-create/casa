...
RSpec.describe CaseContactDecorator do
  describe "#duration_minutes" do
    context "when duration_minutes is less than 60" do
      it "returns only minutes" do
        case_contact = build_stubbed(:case_contact, duration_minutes: 30)
    ...
    context "when duration_minutes is greater than 60" do
      it "returns minutes and hours" do
        case_contact = build_stubbed(:case_contact, duration_minutes: 135)
  ...
  describe "#contact_made" do
    context "when contact_made is false" do
      it "returns No Contact Made" do
        case_contact = build_stubbed(:case_contact, contact_made: false)
    ...
    context "when contact_made is true" do
      it "returns Yes" do
        case_contact = build_stubbed(:case_contact, contact_made: true)
  ...
  describe "#contact_types" do
    ...
    let(:case_contact) { build_stubbed(:case_contact, contact_types: contact_types) }
  ...
  describe "#medium_icon_classes" do
    context "when medium type is in-person" do
      it "returns the proper font-awesome classes" do
        case_contact = build_stubbed(:case_contact, medium_type: "in-person").decorate
    ...
    context "when medium type is text/email" do
      it "returns the proper font-awesome classes" do
        case_contact = build_stubbed(:case_contact, medium_type: "text/email").decorate
    ...
    context "when medium type is video" do
      it "returns the proper font-awesome classes" do
        case_contact = build_stubbed(:case_contact, medium_type: "video").decorate
    ...
    context "when medium type is voice-only" do
      it "returns the proper font-awesome classes" do
        case_contact = build_stubbed(:case_contact, medium_type: "voice-only").decorate
    ...
    context "when medium type is letter" do
      it "returns the proper font-awesome classes" do
        case_contact = build_stubbed(:case_contact, medium_type: "letter").decorate
    ...
    context "when medium type is anything else" do
      it "returns the proper font-awesome classes" do
        case_contact = build_stubbed(:case_contact, medium_type: "foo").decorate
  ...
  describe "#subheading" do
    context "when all information is available" do
      it "returns a properly formatted string" do
        contact_group = build_stubbed(:contact_type_group, name: "Group X")
        contact_type = build_stubbed(:contact_type, contact_type_group: contact_group, name: "Type X")
        case_contact = build_stubbed(:case_contact, occurred_at: "2020-12-01", duration_minutes: 99, contact_made: false, miles_driven: 100, want_driving_reimbursement: true)
    ...
    context "when some information is missing" do
      it "returns a properly formatted string without extra pipes" do
        contact_group = build_stubbed(:contact_type_group, name: "Group X")
        contact_type = build_stubbed(:contact_type, contact_type_group: contact_group, name: "Type X")
        case_contact = build_stubbed(:case_contact, occurred_at: "2020-12-01", duration_minutes: 99, contact_made: true, miles_driven: 100, want_driving_reimbursement: true)
        case_contact.contact_types = [contact_type]
